...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'A new content has been curated by {user}. Check it out!.create': {
    roles: ['administrator', 'editor', 'subscriber'],
    key: 'content_curated',
    tenantPath: [],
    userPath: [],
  },
  'The content titled {title} has been edited by {user}. Review the changes!.update': {
    roles: ['administrator', 'content-curator', 'subscriber'],
    key: 'content_edited',
    tenantPath: [],
    userPath: [],
  },
  'User {user} has subscribed to your content. Keep up the good work!.create': {
    roles: ['administrator', 'content-curator', 'editor'],
...
const tenantRoles: string[] = ['administrator', 'content-curator', 'editor', 'subscriber', 'guest-user'];

...
export function QuoteListPage(props: QuoteListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getQuotes({
        relations: ['publisher', 'insight.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('publisher', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('insight', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'insight',
          header: 'Insight',
          accessorKey: 'insight',
          cell: ({ row: { original: record } }: any) => record?._count?.insight,
        }
      : null,

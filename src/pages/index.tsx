  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="ROMY - Unleash the power of words, delve into the wisdom of poets like Rumi, Shakespeare, Buddha, and more. Discover, learn, and be inspired every day."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1606607291535-b0adfbf7424f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxxdW90ZXN8ZW58MHx8fHwxNjk1NDYwMDMwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@dmjdenise?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Denise Jans`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`ROMY - Unleash the power of words, delve into the wisdom of poets like Rumi, Shakespeare, Buddha, and more. Discover, learn, and be inspired every day.`}
            </Text>
            <Box

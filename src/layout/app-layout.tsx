...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'content-curator', 'editor', 'subscriber', 'guest-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Insights', path: '/insights', entity: 'insight', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Poets', path: '/poets', entity: 'poet', service: AccessServiceEnum.PROJECT, icon: FiFeather },
